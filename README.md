...
| `fermetures` | jours fériés calculés, congés écrits | proposer un créneau derrière un rideau baissé |
| `rappels` | le SMS de la veille | rappeler deux fois, ou hors des heures permises |
